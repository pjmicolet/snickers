...
private:
  ...
  std::array<NES_ADDRESS_MODE, 256> instToAddressMode = {
      IMPL, INDX, IMPL, INDX, ZP,   ZP,   ZP,   ZP,   IMPL, IMM,  IMPL, IMM,  ABS,  ABS,  ABS,  ABS,  ZP,   INDY, IMPL, INDY, ZPX, ZPX, ZPX, ZPX, IMPL, ABSY, IMPL, ABSY, ABSX, ABSX, ABSX, ABSX,
      ABS,  INDX, IMPL, INDX, ZP,   ZP,   ZP,   ZP,   IMPL, IMM,  IMPL, IMM,  ABS,  ABS,  ABS,  ABS,  ZP,   INDY, IMPL, INDY, ZPX, ZPX, ZPX, ZPX, IMPL, ABSY, IMPL, ABSY, ABSX, ABSX, ABSX, ABSX,
      IMPL, INDX, IMPL, INDX, ZP,   ZP,   ZP,   ZP,   IMPL, IMM,  IMPL, IMM,  ABS,  ABS,  ABS,  ABS,  ZP,   INDY, IMPL, INDY, ZPX, ZPX, ZPX, ZPX, IMPL, ABSY, IMPL, ABSY, ABSX, ABSX, ABSX, ABSX,
      IMPL, INDX, IMPL, INDX, ZP,   ZP,   ZP,   ZP,   IMPL, IMM,  IMPL, IMM,  ABS,  ABS,  ABS,  ABS,  ZP,   INDY, IMPL, INDY, ZPX, ZPX, ZPX, ZPX, IMPL, ABSY, IMPL, ABSY, ABSX, ABSX, ABSX, ABSX,
      IMM,  INDX, IMM,  INDX, ZP,   ZP,   ZP,   ZP,   IMPL, IMM,  IMPL, IMM,  ABS,  ABS,  ABS,  ABS,  ZP,   INDY, IMPL, INDY, ZPX, ZPX, ZPX, ZPY, IMPL, ABSY, IMPL, ABSY, ABSX, ABSX, ABSX, ABSX,
      IMM,  INDX, IMM,  INDX, ZP,   ZP,   ZP,   ZP,   IMPL, IMM,  IMPL, IMM,  ABS,  ABS,  ABS,  ABS,  ZP,   INDY, IMPL, INDY, ZPX, ZPX, ZPX, ZPY, IMPL, ABSY, IMPL, ABSY, ABSX, ABSX, ABSX, ABSX,
      IMM,  INDX, IMM,  INDX, ZP,   ZP,   ZP,   ZP,   IMPL, IMM,  IMPL, IMM,  ABS,  ABS,  ABS,  ABS,  ZP,   INDY, IMPL, INDY, ZPX, ZPX, ZPX, ZPX, IMPL, ABSY, IMPL, ABSY, ABSX, ABSX, ABSX, ABSX,
      IMM,  INDX, IMM,  INDX, ZP,   ZP,   ZP,   ZP,   IMPL, IMM,  IMPL, IMM,  ABS,  ABS,  ABS,  ABS,  ZP,   INDY, IMPL, INDY, ZPX, ZPX, ZPX, ZPX, IMPL, ABSY, IMPL, ABSY, ABSX, ABSX, ABSX, ABSX
  };
